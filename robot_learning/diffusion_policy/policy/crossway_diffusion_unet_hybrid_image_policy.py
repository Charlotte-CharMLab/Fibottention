...
from diffusion_policy.model.vision.feature_nets import ViT_Tiny, ViT_Small, ViT_Base
    ...
    def __init__(self, 
        ...
        for obs_net in obs_encoder.obs_nets:
            if __builtins__['type'](obs_encoder.obs_nets[obs_net]) == rmbn.VisualCore:
                print('Found visual backbone... Replacing it with ViT')
                ...
                obs_encoder.obs_nets[obs_net] = ViT_Base(img_size=input_shape[1], patch_size=8) # ViT - Base
